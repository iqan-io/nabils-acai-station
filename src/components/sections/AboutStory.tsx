  ...
  return (
    <section className="grid min-h-[35rem] border-b-2 border-[#47206e] bg-[#ef2b37] text-white lg:grid-cols-[1.05fr_0.95fr]">
      <div className="flex flex-col justify-center px-6 py-16 sm:px-10 lg:px-[max(2.5rem,calc((100vw-80rem)/2))]">
        ...
        <h1 className="mt-5 max-w-2xl font-home-display text-[clamp(2.5rem,6vw,4.5rem)] leading-[1.02]">Family shop. Big sweet energy.</h1>
      ...
      <div className="relative min-h-[28rem] border-t-2 border-[#47206e] lg:border-l-2 lg:border-t-0">
        ...
        <span className="absolute bottom-5 right-5 bg-[#c4dc67] px-5 py-3 font-home-display text-xl text-[#47206e]">Made for sweet moments.</span>
      </div>
    </section>
  );
}
      ...
      <div className="mx-auto max-w-6xl px-6 py-16 md:py-24 lg:px-10">
        <div className="grid border-2 border-[#47206e] bg-white lg:grid-cols-[0.82fr_1.18fr]">
          ...
          <div className="p-7 sm:p-10 lg:p-14">
            ...
            <h2 className="mt-4 font-home-display text-4xl leading-[1.04] text-[#47206e] md:text-5xl">{founder.name}</h2>
            ...
            {founder.pullQuote && <blockquote className="mt-9 border-2 border-[#47206e] bg-[#c4dc67] p-6 font-home-display text-2xl leading-[1.22] text-[#47206e]">{founder.pullQuote}</blockquote>}
          </div>
        </div>
      </div>
    </section>
